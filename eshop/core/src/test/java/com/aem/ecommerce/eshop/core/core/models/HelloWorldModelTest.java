 ...
 */
package com.aem.ecommerce.eshop.core.core.models;
...
import com.aem.ecommerce.eshop.core.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "eshop/components/helloworld");
